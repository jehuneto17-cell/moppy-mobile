...
const PATHS: Record<string, string> = {
  ...
  cleaning: "M4 22 12 14 M14.5 9.5 20 4 M9 13 6 20l-2-2 3-6Z M11.5 10.5 15 3l3 3-5.5 6.5Z",
  "heavy-clean": "M4 9h16l-1.5 10.5a2 2 0 0 1-2 1.5H7.5a2 2 0 0 1-2-1.5Z M9 9V6a3 3 0 0 1 6 0v3",
