...
const styles = StyleSheet.create({
  ...
  countdownBox: { alignSelf: "flex-start", marginTop: space.s, paddingVertical: space.s, paddingHorizontal: space.l, backgroundColor: C.errorBg, borderRadius: radius.l },
  ...
  photoThumb: { width: 56, height: 56, borderRadius: radius.l, backgroundColor: C.border, alignItems: "center", justifyContent: "center" },
